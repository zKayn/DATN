    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 w-14 h-14 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 text-white rounded-full shadow-lg hover:shadow-2xl transform hover:scale-110 transition-all duration-300 flex items-center justify-center z-50"
        >
      ...
      {isOpen && (
        <div className="fixed inset-0 md:inset-auto md:bottom-6 md:right-6 md:w-[420px] md:h-[650px] w-full h-full bg-white md:rounded-3xl shadow-2xl flex flex-col z-50 border border-gray-100 overflow-hidden">
          {/* Header */}
          <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 text-white p-5 flex items-center justify-between relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 relative z-10">
              ...
              <div>
                <h3 className="font-bold text-lg">SportHub AI</h3>
                  ...
                  <div className="mt-3 ml-6 md:ml-10 space-y-2">
                    ...
                    {message.suggestedProducts.map((product) => (
                      <div
                        ...
                        className="bg-white rounded-xl p-3 shadow-md border border-gray-100 hover:shadow-lg hover:border-blue-200 transition-all duration-200 cursor-pointer group"
                      >
              ...
              <div className="grid grid-cols-2 md:flex md:flex-wrap gap-2">
                {quickQuestions.map((question, index) => (
                  <button
                    ...
                    className="text-xs px-3 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700 rounded-xl hover:from-blue-100 hover:to-indigo-100 transition-all duration-200 border border-blue-100 font-medium"
                  >
                    {question}
                  </button>
                ))}
          ...
          <div className="p-3 md:p-4 border-t border-gray-200 bg-white safe-area-bottom">
            <div className="flex gap-2">
              <input
                ...
                disabled={loading}
                className="flex-1 px-3 md:px-4 py-2.5 md:py-3 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-100 text-sm placeholder:text-gray-400"
              />
              <button
                onClick={handleSend}
                disabled={loading || !input.trim()}
                className="w-11 h-11 md:w-12 md:h-12 bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-2xl hover:from-blue-700 hover:to-blue-800 disabled:from-gray-300 disabled:to-gray-300 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center shadow-md hover:shadow-lg"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
