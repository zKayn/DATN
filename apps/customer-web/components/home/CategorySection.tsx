...
export default function CategorySection() {
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-3 px-8 py-4 rounded-full
              ...
              <span className="w-3 h-3 rounded-full bg-gradient-to-r from-primary-500 to-secondary-500 animate-pulse" />
  ...
  return (
    <section className="py-12 md:py-16 bg-gradient-to-br from-white via-primary-50/30 to-accent-50/20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div
          ref={headerRef}
          className="text-center mb-10 transition-all duration-1000 opacity-100 translate-y-0"
        >
          {/* Title badge */}
          <div className="inline-flex items-center gap-3 px-8 py-4 rounded-full
                        bg-gradient-to-r from-primary-500/10 to-secondary-500/10
